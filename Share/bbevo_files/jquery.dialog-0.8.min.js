...
</50?l.top-j:l.top-j+m:h+(f-j)></50?l.top+m:l.top:b></0||n.clientx<2||n.clientx></a.height-f-k&&b.content.height(a.height-f-k);if(!a.fixedwidth){if(a.width&&a.width></0&&d.close(i);d.build(a);a.isload=1;return></100)a.autoclose*=1e3;if(typeof>